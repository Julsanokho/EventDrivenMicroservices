package com.sanokho.OrderService.command.api.saga;

import com.sanokho.CommonService.commands.*;
import com.sanokho.CommonService.events.*;
...
public class OrderProcessingSaga {
    ...
    private void orderHandler(OrderCreatedEvent event){
    ...
    public void handle(PaymentCancelEvent event){
        log.info("PaymentCancelEvent in saga for Order Id : {} ",
                event.getOrderId());
        cancelOrderCommand(event.getOrderId());
    }
}
